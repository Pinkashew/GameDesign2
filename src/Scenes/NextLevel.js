class NextLevel extends Phaser.Scene {
    ...
    create() {
        ...
        this.level = this.add.text(16, 84, "Level " + "2", { fontFamily: "'Roboto'", fontSize: '16px', fill: '#ADD8E6' });
    ...
    update() {
        ...
        if (this.score >= 40) {
            this.add.text(100, 300, "Go to Last Level Press L", { fontFamily: "'Roboto'", fontSize: '48px', fill: '#ADD8E6' })
            for (let i = 0; i < this.animals.length; i++) {
                this.animals[i].destroy();
            }
            this.animals = [];
