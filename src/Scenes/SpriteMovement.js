class SpriteMovement extends Phaser.Scene {
    constructor() {
        super("spriteMovement");
        this.my = {sprite: {}};
    ...
    create() {
        ...
        this.level = this.add.text(16, 84, "Level " + "1", { fontFamily: "'Roboto'", fontSize: '16px', fill: '#ADD8E6' });
        ...
        document.getElementById('description').innerHTML = '<h2>Animal Shooter</h2><h3>Your objective is to shoot the animals and not let them reach the city which is behind you<h3><br>A: left // D: right // Space: Fire Arrow // S: Start Game // R: Reset Game // T: Title Screen can only be pressed when game is not active'
    }
    ...
    update() {
        ...
        if (this.score >= 20) {
            this.add.text(100, 300, "Go to Next Level Press L", { fontFamily: "'Roboto'", fontSize: '48px', fill: '#ADD8E6' })
            for (let i = 0; i < this.animals.length; i++) {
                this.animals[i].destroy();
            }
            this.animals = [];
